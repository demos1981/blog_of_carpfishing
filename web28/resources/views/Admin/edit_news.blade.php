...
<section class="wrapper">
    <div class="wrapperBorder">
        ...
        <form action="add_news" method="POST" enctype="multipart/form-data">
            @csrf
            {{csrf_field()}}
            <h1>Добавить в раздел "Новости"</h1>
            ...
            <input type="text" placeholder="News Title" name="title" value="{{$news->title}}">
            <textarea placeholder="News Body" name="body">{{$news->body}}</textarea>
